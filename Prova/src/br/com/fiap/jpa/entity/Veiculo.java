...
@Entity
@Table(name="T_NR_VEICULO")
@SequenceGenerator(allocationSize=1, name="veiculo", sequenceName="SQ_T_NR_VEICULO")
public class Veiculo {
	...
	public Veiculo(String placa, String cor, int ano, List<Motorista> motoristas) {
		super();
		this.placa = placa;
		this.cor = cor;
		this.ano = ano;
